...
maximum_number_of_mpi_processes=4;	# Da das System nur 4 Prozessor-Kerne besitzt, koennen mit der OpenMPI-Implementierung nicht ohne Weiteres mehr als 4 Prozesse erzeugt werden.
