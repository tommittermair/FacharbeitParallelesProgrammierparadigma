		...
		\subsection{Lösungen zu den Problemen der parallelen Verarbeitung}
			...
			\subsubsection{Lösungen zum zeitkritischen Ablauf}
				...
				\begin{description}
					...
					\item[{\parbox[t]{1.2\linewidth}{Wechselseitiger Ausschluss unter Verwendung von aktivem \\Warten}}] % Da die Überschrift zu lang ist, muss ein Zeilenumbruch eingefügt werden. Dies funktioniert nur auf diese Weise.
					...
					\item[{\parbox[t]{1.2\linewidth}{Wechselseitiger Ausschluss unter Verwendung von Semapho-\\ren}}] % Da die Überschrift zu lang ist, muss ein Zeilenumbruch eingefügt werden. Dies funktioniert nur auf diese Weise.
						...
						\begin{description}
							...
							\item[{\parbox[t]{1.2\linewidth}{Lösung des Erzeuger-Verbraucher-Problems unter Ver-\\wendung von Semaphoren}}] % Da die Überschrift zu lang ist, muss ein Zeilenumbruch eingefügt werden. Dies funktioniert nur auf diese Weise.
